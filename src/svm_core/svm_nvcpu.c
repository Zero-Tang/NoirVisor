...
void nvc_svmn_virtualize_entry_vmcb(noir_svm_vcpu_p vcpu,void* l2_vmcb,void* l1_vmcb)
{
	...
	noir_svm_vmwrite64(l1_vmcb,guest_fs_selector,noir_svm_vmread64(vcpu->vmcb.virt,guest_fs_selector));
	noir_svm_vmwrite64(l1_vmcb,guest_fs_attrib,noir_svm_vmread64(vcpu->vmcb.virt,guest_fs_attrib));
	...
	noir_svm_vmwrite64(l1_vmcb,guest_gs_selector,noir_svm_vmread64(vcpu->vmcb.virt,guest_gs_selector));
	noir_svm_vmwrite64(l1_vmcb,guest_gs_attrib,noir_svm_vmread64(vcpu->vmcb.virt,guest_gs_attrib));
	...
	noir_svm_vmwrite64(l1_vmcb,guest_tr_selector,noir_svm_vmread64(vcpu->vmcb.virt,guest_tr_selector));
	noir_svm_vmwrite64(l1_vmcb,guest_tr_attrib,noir_svm_vmread64(vcpu->vmcb.virt,guest_tr_attrib));
	...
	noir_svm_vmwrite64(l1_vmcb,guest_ldtr_selector,noir_svm_vmread64(vcpu->vmcb.virt,guest_ldtr_selector));
	noir_svm_vmwrite64(l1_vmcb,guest_ldtr_attrib,noir_svm_vmread64(vcpu->vmcb.virt,guest_ldtr_attrib));
...
void nvc_svmn_virtualize_exit_vmcb(noir_svm_vcpu_p vcpu,void* l1_vmcb,void* l2_vmcb)
{
	...
	noir_svm_vmwrite64(l2_vmcb,guest_fs_selector,noir_svm_vmread64(vcpu->vmcb.virt,guest_fs_selector));
	noir_svm_vmwrite64(l2_vmcb,guest_fs_attrib,noir_svm_vmread64(vcpu->vmcb.virt,guest_fs_attrib));
	...
	noir_svm_vmwrite64(l2_vmcb,guest_gs_selector,noir_svm_vmread64(vcpu->vmcb.virt,guest_gs_selector));
	noir_svm_vmwrite64(l2_vmcb,guest_gs_attrib,noir_svm_vmread64(vcpu->vmcb.virt,guest_gs_attrib));
	...
	noir_svm_vmwrite64(l2_vmcb,guest_tr_selector,noir_svm_vmread64(vcpu->vmcb.virt,guest_tr_selector));
	noir_svm_vmwrite64(l2_vmcb,guest_tr_attrib,noir_svm_vmread64(vcpu->vmcb.virt,guest_tr_attrib));
	...
	noir_svm_vmwrite64(l2_vmcb,guest_ldtr_selector,noir_svm_vmread64(vcpu->vmcb.virt,guest_ldtr_selector));
	noir_svm_vmwrite64(l2_vmcb,guest_ldtr_attrib,noir_svm_vmread64(vcpu->vmcb.virt,guest_ldtr_attrib));
