...
for %%1 in (..\zydis\src\*.c) do (clang-cl %%1 /I"..\zydis\include" /I"..\zydis\dependencies\zycore\include" /I"..\zydis\msvc" /I"..\zydis\src" /Zi /W3 /WX /O2 /Oi /D"ZYDIS_STATIC_DEFINE" /D"ZYAN_NO_LIBC" /Fa"%objpath%\%%~n1.cod" /Fo"%objpath%\%%~n1.obj" /GS- /Gy /Gr /TC /c)

clang-cl ..\disasm.c /I"..\zydis\include" /I"..\zydis\dependencies\zycore\include" /I"..\zydis\msvc" /Zi /W3 /WX /O2 /Oi /D"ZYDIS_STATIC_DEFINE" /D"ZYAN_NO_LIBC" /Fa"%objpath%\disasm.cod" /Fo"%objpath%\disasm.obj" /GS- /Gy /Gr /TC /c
