...
for %%1 in (..\zydis\src\*.c) do (clang-cl %%1 /I"..\zydis\include" /I"..\zycore-c\include" /I"..\zydis\msvc" /I"..\zydis\src" /Zi /W3 /WX /Od /Oi /D"ZYDIS_STATIC_DEFINE" /D"ZYAN_NO_LIBC" /Fa"%objpath%\%%~n1.cod" /Fo"%objpath%\%%~n1.obj" /GS- /Gr /TC /c)

clang-cl ..\disasm.c /I"..\zydis\include" /I"..\zycore-c\include" /I"..\zydis\msvc" /Zi /W3 /WX /Od /Oi /D"ZYDIS_STATIC_DEFINE" /D"ZYAN_NO_LIBC" /Fa"%objpath%\disasm.cod" /Fo"%objpath%\disasm.obj" /GS- /Gr /TC /c
