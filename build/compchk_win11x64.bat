...
echo ============Start Linking============
link "%objpath%\*.obj" "%objpath%\version.res" "..\target\x86_64-pc-windows-msvc\debug\nvcore.lib" /LIBPATH:"%libpath%\10.0.26100.0\km\x64" /NODEFAULTLIB "ntoskrnl.lib" "hal.lib" /NOLOGO /DEBUG /PDB:"%binpath%\NoirVisor.pdb" /OUT:"%binpath%\NoirVisor.sys" /SUBSYSTEM:NATIVE /Driver /ENTRY:"NoirDriverEntry" /Machine:X64 /ERRORREPORT:QUEUE
