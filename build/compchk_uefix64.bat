...
for %%1 in (..\src\vt_core\*.c) do (clang-cl %%1 /I"..\src\include" /Zi /W3 /WX /Od /D"_llvm" /D"_amd64" /D"_vt_core" /D"_%%~n1" /Fa"%objpath%\%%~n1.cod" /Fo"%objpath%\%%~n1.obj" /GS- /Gr /TC /c -Wno-incompatible-pointer-types -Wno-pointer-sign)

echo Compiling Core Engine of AMD-V...
for %%1 in (..\src\svm_core\*.c) do (clang-cl %%1 /I"..\src\include" /Zi  /W3 /WX /Od /D"_llvm" /D"_amd64" /D"_svm_core" /D"_%%~n1" /Fa"%objpath%\%%~n1.cod" /Fo"%objpath%\%%~n1.obj" /GS- /Gr /TC /c -Wno-incompatible-pointer-types -Wno-pointer-sign)
